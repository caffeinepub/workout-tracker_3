...
import { Plus, Trash2, Loader2, Layers, ChevronRight, Lock } from 'lucide-react';
...
export default function PhasesPage() {
  ...
  const [selectedPhase, setSelectedPhase] = useState<{ id: PhaseId; name: string } | null>(null);
    ...
    <div className="container mx-auto px-4 py-8 max-w-2xl">
      ...
      {!isLoading && !isError && phases && phases.length === 0 && (
        <div className="text-center py-16 text-muted-foreground">
          ...
          <p className="text-xs mt-1">Create your first training phase above.</p>
        </div>
      )}
        ...
        <div className="space-y-3">
          {phases.map((phase) => (
            <Card
              ...
              onClick={() => setSelectedPhase({ id: phase.id, name: phase.name })}
            >
