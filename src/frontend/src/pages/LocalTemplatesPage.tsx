                            ...
                            {isEditing ? (
                              ...
                              >
                                <Input
                                  ...
                                  onKeyDown={(e) =>
                                    handleEditKeyDown(e, template.id)
                                  }
                              ...
                              <>
                                <button
                                  type="button"
                                  className="font-semibold truncate cursor-pointer text-left bg-transparent border-0 p-0"
                                  onClick={() =>
                                ...
                                <button
                                  type="button"
                                  onClick={(e) =>
                                    startEditing(e, template.id, template.name)
                                  }
